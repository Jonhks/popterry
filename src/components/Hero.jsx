...
// import { FaStar } from "react-icons/fa"; // Ejemplo de icono, puedes cambiarlo
    ...
    <section className="relative w-full h-[80vh] flex flex-col">
      ...
      <div className="relative z-10 flex flex-1 items-center justify-between px-8 py-[2rem]">
        ...
        <div className="w-1/3 text-left ">
          ...
          <span className="mt-2 text-[14px] text-white drop-shadow p-1 pl-3 pr-3 rounded-[50px] bg-[var(--secundario)] font-[chillax-m] md:text-[24.50px] leading-[29.04px]">
            PARA TODA LA
          </span>
          <p className="mt-4 text-lg text-white drop-shadow font-[cenzo] md:text-[64.62px] leading-[77.55px]">
            LA FAMILIA
          </p>
        </div>
      ...
      {/* Contenido inferior */}
      <div className="relative z-10 flex flex-row items-center justify-center h-1/2 py-[4rem]">
        <img
          src={logo}
          alt="Logo"
          className="h-16 w-16"
        ...
        <p className="w-[50%] text-xl font-semibold text-blue-900">
          ...
          esfuerzo constante, hemos construido una sólida red comercial que nos
          impulsa a seguir creciendo y posicionándonos como una marca referente
          en la industria de snacks en México.{" "}
        </p>
      </div>
    </section>
  );
